...
export function HomePage(props: HomePageProps) {
  ...
  return (
    <HomeContextProvider>
      <div>
        <h1 className="text-3xl py-4">Students manager</h1>
      </div>
      <div className="mt-12 flex-wrap	 flex-col lg:flex-row flex justify-between	">
        <div className="flex lg:w-2/4 w-full flex-wrap">
          <div className="relative w-48 mr-12 lg:w-auto inline-block text-gray-600">
            <InputSearch placeholder="Search book..." onChange={handleSearchChange} />
